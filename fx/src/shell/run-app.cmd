...
if defined JAVAFX_PATH (
    if not "%JAVAFX_PATH%"=="" (
        ...
        start javaw --module-path "%JAVAFX_PATH%\lib" --add-modules javafx.controls,javafx.web,javafx.graphics --enable-native-access=javafx.graphics -jar cyberferret-fx.jar
        exit /b 0
    ) else (
        goto error
    )
